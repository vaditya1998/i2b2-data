...
insert into QT_BREAKDOWN_PATH (NAME,VALUE,CREATE_DATE,UPDATE_DATE,USER_ID) values ('PATIENT_MEDICATION_CSV','<?xml version="1.0"?><ValueExporter>
  <File>
	...
	<Query>SELECT cast(a.PATIENT_NUM as varchar) as "I2B2_PATIENT_NUMBER"
        ,a.start_date as "START_DATE",a.start_date as "END_DATE",b.name_char as "MEDICATION_NAME"
        ,b.concept_cd as "NDC_CODE",a.units_cd as "UNIT",a.quantity_num as "DOSE_QUANTITY"     
        ,a.instance_num as "INSTANCE_NUM",a.modifier_cd as "MODIFIER" ,m.name_char as "MODIFIER_NAME" ,a.location_cd as "FACILITY",w.name_char as "ENCOUNTER_TYPE"
        ,p.name_char as "PROVIDER" ,cast(a.encounter_num as varchar) as "ENCOUNTER_NUMBER"
