...
*/
  ...
  /* OTHER SITE SPECIFIC CONCEPTS CAN BE ADDED HERE - DON'T FORGET TO ADD ONTOLOGY ITEMS IN usp [FastTotalnumPrep] */
...
*/
  ...
  /* SITE SPECIFIC PATIENT KEY PAIRS CAN BE ADDED HERE
EX: UNION SELECT PATIENT_NUM, TRY_CAST(FINANCIAL_STATUS AS VARCHAR(50)) AS CONCEPT_CD FROM PATIENT_VISIT_PRELIM */
...
(VAL FOR FACT IN (/*[AGE_TODAY],[AGE_VISIT], [AGE_TODAY_LT18]
  ...
  /* ADD SITE SPECIFIC COLUMN NAMES HERE AS WELL */
;
