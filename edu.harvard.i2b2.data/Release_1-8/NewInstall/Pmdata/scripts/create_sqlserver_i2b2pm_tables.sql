...
SET IDENTITY_INSERT PM_GLOBAL_PARAMS ON;
...
INSERT INTO PM_GLOBAL_PARAMS ( ID, DATATYPE_CD, PARAM_NAME_CD, PROJECT_PATH, VALUE, CAN_OVERRIDE, CHANGE_DATE, ENTRY_DATE, CHANGEBY_CHAR, STATUS_CD)
  VALUES('3', 'T', 'Predefined User Params', '/',   '[{ "label": "PM_EXPIRED_PASSWORD", "dataType": "T", "description": "When the user changes expired password, system automatically adds row in PM_USER_PARAMS." }]',  NULL, getdate(), getdate(), NULL, 'A');  
SET IDENTITY_INSERT PM_GLOBAL_PARAMS OFF;